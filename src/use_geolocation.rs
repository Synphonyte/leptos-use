        ...
        resume = {
            ...
            sendwrap_fn!(move || {
                    ...
                    && let Ok(geolocation) = navigator.geolocation()
                {
                    ...
                    let handle = geolocation.watch_position_with_error_callback_and_options(
                    ...
                    *watch_handle.lock().unwrap() = handle;
    ...
    PauseFn: Fn() + Clone + Send + Sync,
{
    ...
    pub coords: OptionLocalSignal<web_sys::Coordinates>,
    ...
    pub error: OptionLocalSignal<web_sys::PositionError>,
