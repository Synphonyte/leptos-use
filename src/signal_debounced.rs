...
signal_filtered_local!(
    ...
    /// ```
    /// # use leptos::prelude::*;
    /// # use leptos_use::signal_debounced_local;
    ...
    /// ```
    /// # use leptos::prelude::*;
    /// # use leptos_use::{signal_debounced_local_with_options, DebounceOptions};
    /// # use std::cell::RefCell;
    /// #
    /// # #[component]
    /// # fn Demo() -> impl IntoView {
    /// let (input, set_input) = signal_local(RefCell::new(0));
    /// let debounced: Signal<RefCell<i32>, _> = signal_debounced_local_with_options(
    ///     input,
    ///     1000.0,
    ///     DebounceOptions::default().max_wait(Some(500.0))
    /// );
